...
public class Constants {
    ...
    public static final String URL_SERVER_JSON_DELETE_EVENT = URL_SERVER + "event/delete";
    public static final String URL_SERVER_JSON_SET_EVENT_RESULT = URL_SERVER + "event/postResult";
    ...
    public static final String URL_SERVER_JSON_ADD_TEAM = URL_SERVER + "team/insert";
